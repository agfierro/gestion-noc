...
NOC.Clientes=(()=>{
 ...
 async function render(search=""){
   ...
   const q=search.toLowerCase(),f=q?rows.filter(r=>[r.nombre_tienda,r.nombre,r.apellidos,r.localidad_facturacion,r.provincia_facturacion,r.comercial].join(" ").toLowerCase().includes(q)):rows;
