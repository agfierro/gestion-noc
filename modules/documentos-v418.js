...
NOC.Documentos=(()=>{
  ...
  async function ajustarDocumentoAPaginas(sheet){
    ...
    const pages=Math.max(1,Math.ceil((naturalH+1)/pageH));
    // Un pequeño margen de seguridad evita que el redondeo de Safari/html2pdf
    // cree una hoja adicional vacía.
    const target=Math.max(0,pages*pageH-naturalH-4);
