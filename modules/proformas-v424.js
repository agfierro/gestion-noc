...
function taxFor(c){
 ...
 async function save(id){
  ...
  base+=form.envio_precio*(1-form.envio_descuento/100);
 ...
 async function ver(id){
  ...
  NOC.App.modal(`<div class="modal-head"><strong>Proforma ${NOC.App.esc(p.numero)}</strong><button class="icon-btn" onclick="NOC.App.closeModal()">×</button></div><div class="modal-body">${html}</div><div class="modal-foot"><button class="btn" onclick="NOC.Documentos.imprimirActual()">Imprimir / Guardar PDF</button></div>`,false,"document-modal");
}
