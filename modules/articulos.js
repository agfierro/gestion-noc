...
NOC.Articulos=(()=>{
 ...
 async function render(search=""){
   ...
   </tbody></table></div></div>`;document.getElementById("artSearch").addEventListener("input",async e=>{const v=e.target.value,pos=e.target.selectionStart;await render(v);const n=document.getElementById("artSearch");if(n){n.focus({preventScroll:true});try{n.setSelectionRange(pos,pos)}catch(_){}}})
 }
