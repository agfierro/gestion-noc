...
NOC.Informes=(()=>{
  ...
  async function generarArticulos(){
    ...
    try{
      ...
      currentCriteria={report:"articulos",desde,hasta,fabrica,tipo,articuloId,origen:"proformas"};
      NOC.App.hideProgress();
      drawArticulosResult();
    }catch(e){
      NOC.App.hideProgress();
    ...
    box.innerHTML=`
      ...
      <div class="table-wrap">
        <table class="report-table">
          <thead><tr><th>Artículo</th><th>SKU</th><th>Tipo</th><th>Fábrica</th><th class="num">Unidades pedidas</th><th class="num">Importe líneas</th></tr></thead>
  ...
  async function generarComercial(){
    ...
    try{
      ...
      if(error)throw error;
      currentRows=data||[];
      currentCriteria={report:"comercial",comercial,tipo,etiqueta,desde,hasta,orden:"fecha",dir:"asc"};
      NOC.App.hideProgress();
  ...
  return{render,cambiarInforme,generarComercial,ordenarComercialResultado,generarVentas,generarProformas,limpiarProformas,ordenarProformasResultado,generarClientes,generarClientesInactivos,ordenarClientesResultado,ordenarClientesInactivos,generarArticulos,generarFiscal3000,exportCsv,imprimir};
})();