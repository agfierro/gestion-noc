     ...
     <div class="modern-page-head">
       ...
       <div class="modern-head-actions">
         <div class="modern-search">
           ...
           <input id="pfModernSearch" placeholder="Buscar por Nº o cliente…" value="${NOC.App.esc(pfQuery)}" oninput="NOC.Proformas.searchModern(this.value)">
         </div>
...
function taxFor(c){
 ...
 return{render,openEditor,addLine,removeLine,patchLine,save,toggle,openStatus,openBulkStatus,setStatus,applyBulkStatus,facturar,facturarSeleccionadas,ver,refreshModern,clearModernFilters,toggleAllVisible,updateBulkBar,bulkSetStatus,deleteSelected,selectedFromScreen,setSort,openLinkedInvoice,searchModern}
})();